...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    {
        private readonly ConfigurationImagem _myConfig;
        private readonly IWebHostEnvironment _hostingEnvironment;

        public AdminImagensController(IWebHostEnvironment hostingEnvironment, IOptions<ConfigurationImagem> myConfiguration)
        {
        ...
        public IActionResult GetImagens()
        {
            ...
            model.PathImagensProdutos = _myConfig.NomePastaImagensProdutos;
